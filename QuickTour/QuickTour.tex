...
\dothis{Using the mouse (and the appropriate modifier keys), \metaclick on the \bam. \footnote{Remember, you may have to set the \ct{halosEnabled} option in the Preferences Browser. \btc{can't see this setting in Setting Browser - still valid?} } }
